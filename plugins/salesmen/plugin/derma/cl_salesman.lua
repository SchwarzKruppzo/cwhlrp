...
function PANEL:Init()
	...
	function self.btnClose.DoClick(button)
		...
		Clockwork.datastream:Start("SalesmanAdd", {
			...
			skin = Clockwork.salesman.skin,
			bgroups = Clockwork.salesman.bgroups,
		...
		Clockwork.salesman.skin = nil;
		Clockwork.salesman.bgroups = nil;
	...
	self.skin = self.settingsForm:TextEntry("The skin of the salesman.");
	self.bgroups = self.settingsForm:TextEntry("The bodygroups of the salesman.");
	...
	self.skin:SetValue(Clockwork.salesman.skin);
	self.bgroups:SetValue(Clockwork.salesman.bgroups);
...
function PANEL:Think()
	...
	Clockwork.salesman.skin = self.skin:GetValue();
	Clockwork.salesman.bgroups = self.bgroups:GetValue();
